for(t in TimePoints[-1]){
  ...
  for(m in Medications){
    tryCatch({
      Y <- ModelData[ModelData[,paste(m,"_lag",sep="")] == 1,paste("PickUp_",m,sep="")]
      assign(paste("model_PickUp_",m,"_",t,sep=""),SuperLearner(Y,ModelDataX[ModelData[,paste(m,"_lag",sep="")] == 1,],family=binomial(),SL.library = SLvector))
      saveRDS(get(paste("model_PickUp_",m,"_",t,sep="")),file=paste("L:/afdelingen/Actuariaat_Business/DennisS/PhD/A4/Models/model_PickUp_",m,"_",t,".rda",sep=""))
